...
async function run() {
  ...
  try {
    ...
    const result = { manifestResult, automationCoverageResult, settingsMergeSafetyResult, optionsResult, articleResult, overlayTabOrderResult, structureResult, tabOrderResult, lateInjectionResult, lateInjectionStatusResult, summaryResult, focusReaderResult, formResult, formSummaryResult, popupResult };
